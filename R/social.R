...
social <- function(github_username = "Gchism94",
  ...
  glue::glue(
    "<span style='background-color: {bg_col}; padding: 10px; font-family:\"Font Awesome 6 Brands\"; color: {icon_col};'>{github_icon}</span>
      <span style='background-color: {bg_col}; padding: 10px; color: {text_col}; font-family: {body_font};'> {github_username}</span><br>
      <span style='background-color: {bg_col}; padding: 10px; font-family:\"Font Awesome 6 Brands\"; color: {icon_col};'>{linkedIn_icon}</span>
      <span style='background-color: {bg_col}; padding: 10px; color: {text_col}; font-family: {body_font};'> {linkedIn_username}</span><br>
      <span style='background-color: {bg_col}; padding: 10px; font-family:\"Font Awesome 6 Brands\"; color: {icon_col};'>{web_icon}</span>
      <span style='background-color: {bg_col}; padding: 10px; color: {text_col}; font-family: {body_font};'> {web_link}</span>"
  )
}
